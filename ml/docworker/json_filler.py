...
with open('new_NER-master/example.json', encoding='utf-8') as r:
    pattern = json.load(r)
    with open('new_NER-master/example_struct.json', 'w', encoding='utf-8') as w:
        json.dump(pattern, w, indent=4, ensure_ascii=False)

with open('new_NER-master/pattern.json', encoding='utf-8') as r:
    pattern = json.load(r)
    with open("new_NER-master/pattern_stract.json", 'w', encoding='utf-8') as w:
        json.dump(pattern, w, indent=4, ensure_ascii=False)


def get_marcup():
    text_marcup = TextMarkUp(is_bert=True, is_pro_bert=True, download=True)
    with open('new_NER-master/doc.txt', 'r', encoding='utf-8') as file:
...
pattern = load_json(path='new_NER-master/pattern_stract.json')
example = load_json(path='new_NER-master/example_struct.json')
...
with open('new_NER-master/new_example_struct.json', 'w', encoding='utf-8') as f:
